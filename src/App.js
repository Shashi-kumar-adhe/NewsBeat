...
import business from '../src/business.json'
import general from './components/news.json'
...
function App() {
  ...
  <Router>
    <Navbar/>
    <Routes>
        <Route path='/' element={<News name={articles} head="General" />}/>      
        ...
        <Route path="News_App" element={<News name={articles} head="General" />}/>
